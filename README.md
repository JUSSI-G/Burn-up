...
- Since the scope can grow mid-project, the step-after chart style makes scope increases visible immediately
- Add or remove sprints dynamically and summary totals update in the header
